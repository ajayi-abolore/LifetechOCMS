...
$qry->execute();
$row=$qry->fetch(PDO::FETCH_ASSOC);  // src="../../lifethemes/'.$row['theme_name'].'/lifelayout/'.$row['lifelayout'].'"/
...
<form action="" post="method">
	<table border="1" width="600px">
        <tr>										
        	<td width="600px" height="500px"> <?php  echo '<img  width="1200px" height="700px" src="../../lifethemes/'.$row['theme_name'].'/lifeblock/'.$row['lifelayout'].'"/>'  ?> </td>        
        </tr>
        <tr>
